...
<body>
		...
		<a href="./boardQnAPage">목록</a>
		<c:if test="${sessionData.ad_idx !=null && sessionData.m_idx == boardDataVO.contentDataVO.m_idx}"> <!-- 비회원일 경우 null.m_idx니까 오류...! -->
			<a href="./updateQnAForm?b_idx=${boardDataVO.contentDataVO.b_idx }">수정</a>
