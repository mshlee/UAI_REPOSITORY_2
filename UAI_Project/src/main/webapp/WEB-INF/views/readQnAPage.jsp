                ...
                <div id="middle-small-2">
                    ...
                    <div id="notice-table-box"  >
	                    <div id="notice-view">
							...
							<hr class="dot-line">
							<div id="writer">
								&nbsp;&nbsp;<img src="./img/signUp.png" id="logo-writer"> ${boardDataVO.memberDataVO.m_nick }<br>
							</div>
							...
							<hr class="dot-line-2">
								 ...
								 <div id="replyBox"><c:choose>
								 <c:when test="${!empty sessionData.ad_idx }">
										<form action = "writeReplyAction" method="post">
													${sessionData.ad_nick }
													<input type="text" class="form-control" name="b_content" placeholder="댓글은 자신의 얼굴입니다">
													...
													<input type="hidden" name="p_name" value="reply">
													...
													<br>
													<input class="btn btn-primary btn-xs" type="submit" value="Submit" name="submit" id="reply-submit">
										</form>
												</c:when>
									...
									<div id="go-to-list">
										<c:if test="${sessionData.m_idx !=null && sessionData.m_idx == boardDataVO.contentDataVO.m_idx}"> <!-- 비회원일 경우 null.m_idx니까 오류...! -->
											...
											<a style="color: black" href="./updateQnAForm?b_idx=${boardDataVO.contentDataVO.b_idx }"><button class="btn btn-primary">수정</button></a>
										</c:if>
										<a style="color: black" href="./boardQnAPage"><button class="btn btn-info">목록</button></a>
							       </div>
						
						
                    	</div><!-- notice view -->
                    
					</div><!-- notice-table-box --> 
