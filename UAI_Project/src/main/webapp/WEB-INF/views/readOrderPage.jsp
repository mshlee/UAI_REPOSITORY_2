                    	...
                    	<table class="notice-table">
					        <tr>
					          ...
					          <c:forEach var="orderList" items="${orderList }">
						            <tr>
						               <td>${orderList.productVO.p_name}</td>
						               <td>${orderList.orderDataVO.o_totalPrice}</td>
						               <c:choose>
						               <c:when test="${orderList.purchaseDataVO.pch_isPaid==0}">
						               <td>미결제</td>
						               </c:when>
						               <c:when test="${orderList.purchaseDataVO.pch_isPaid==1}">
						               <td>결제완료</td>
						               </c:when>
						               </c:choose>						    
						               <td>${orderList.orderDataVO.o_date }</td>
						               <c:choose>
						               <c:when test="${orderList.purchaseDataVO.pch_isPaid==0}">
						               <td>  </td>
						               </c:when>
