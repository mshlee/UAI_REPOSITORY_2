                    ...
                    <div id="notice-table-box">
	                    	<div id="scroll" style="overflow:auto;">
		                    	<table class="notice-table">
						            ...
						            <td>글 타입</td>
							          ...
							          <c:forEach var="boardDataVO" items="${boardDataList }">
											<tr>
												<th>
													<c:choose>
													<c:when test="${boardDataVO.contentDataVO.b_qCategory eq 0}">상품문의</c:when>
													<c:otherwise>결제문의</c:otherwise>
													</c:choose>
												</th>
												 <th>
													 <c:choose>
													 <c:when test="${!empty sessionData.ad_idx}">
													 	 <a href="./readQnAPageByAdmin?b_idx=${boardDataVO.contentDataVO.b_idx }">
										               ...
										               <c:when test="${boardDataVO.contentDataVO.b_isHidden eq 0}">
								                  	   ...
								                  	   <c:otherwise>
								       				 		...
								       				 		<form action="./readQnAPage" method="post" id="PW_box" style="display:block">
								       				 			<img src="./img/lock.png" id="lock"> <input  type="password" name="b_pw">
								                  				<input class="btn btn-xs btn-link" type="submit" value="${boardDataVO.contentDataVO.b_title}">
								                  				...
								                  				<input type="hidden" name="ad_idx" value="${boardDataVO.contentDataVO.ad_idx }">
												...
												<th><c:choose> 
							               			<c:when test="${boardDataVO.contentDataVO.b_isHidden eq'0' }">공개글</c:when>
							      ...
							      <br>
							      <div id="ad-box">
								      <c:if test="${!empty sessionData.m_idx }">
								      <a href="./writeQnAForm"><button class="btn btn-info" style="width:75pt; height:28pt;">질문 작성</button></a>
								      </c:if>
							      </div>
							       <br>
								<div id="search">
