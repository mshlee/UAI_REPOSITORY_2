...
public class ProductVO {
	...
	private int p_nowPrice;
	private String p_teacher;
	private int p_maxStudent;
	...
	private double p_commissionRate;
	...
	public ProductVO(String p_idx, String p_name, String p_type, int p_originalPrice, double p_discountRate,
			String p_totalSaleCount, int p_nowPrice, String p_teacher, int p_maxStudent, String p_startDate,
			String p_lastDate, String p_location, String p_lectureDay, String p_lectureTime, String p_lectureInfo,
			String p_teacherInfo, String p_otherInfo, String p_postDate, double p_commissionRate) {
		...
		this.p_commissionRate = p_commissionRate;
	}
	...
	public int getP_nowPrice() {
		return p_nowPrice;
	}


	public void setP_nowPrice(int p_nowPrice) {
		this.p_nowPrice = p_nowPrice;
	}
	...
	public int getP_maxStudent() {
		return p_maxStudent;
	}


	public void setP_maxStudent(int p_maxStudent) {
		this.p_maxStudent = p_maxStudent;
	}
	...
	public double getP_commissionRate() {
		return p_commissionRate;
	}


	public void setP_commissionRate(double p_commissionRate) {
		this.p_commissionRate = p_commissionRate;
	}
