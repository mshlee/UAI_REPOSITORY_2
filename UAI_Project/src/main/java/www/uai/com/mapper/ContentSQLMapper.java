...
public interface ContentSQLMapper {
	...
	//읽기 선택
	@Select("SELECT B_REFERIDX, B_TYPE, B_CONTENT, B_POSTDATE, B_COUNT, B_ISHIDDEN, B_PW, B_QCATEGORY, B_ISPOST, P_IDX FROM BOARD_CONTENT WHERE b_idx=#{b_idx}")
	...
	P_IDX NUMBER(8),
	AD_IDX NUMBER(8)*/
	@Insert("INSERT INTO BOARD_CONTENT VALUES (Board_Content_Seq.nextVal, #{b_referIdx}, 3, 'reply', #{b_content}, SYSDATE, 0, 0, 'nonePW', 2, 0, #{m_idx}, 0, #{ad_idx})")
