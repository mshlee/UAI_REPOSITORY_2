...
//dy--08.28	
	...
	public ArrayList<ProductVO> selectByCondition(@Param("searchQuery") String searchQuery,
			@Param("startPostNum") int startPost, @Param("endPostNum") int endPost);
	...
	@Select("SELECT DISTINCT P_LOCATION FROM PRODUCT WHERE P_TYPE = #{p_type}")
	public ArrayList<String> selectDistinctLocation(String p_type);
